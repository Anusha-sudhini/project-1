<%-- 
    ...
    Created on : Feb 19, 2020, 12:29:56 PM
    Author     : Venkat
--%>
...
<%
  ...
  String query="select count(*) from student where username='"+username+"' or rollno='"+rollno+"'";
     ...
     count=r.getInt(1);   
       ...
       if(count==0){
         int i=Queries.getExecuteUpdate("insert into student values(null,'"+fname+"','"+lname+"','"+email+"','"+mobile+"','"+address+"','"+gender+"','"+hobbies+"','"+pname+"','"+pemail+"','"+pmobile+"','"+occupation+"','"+username+"','"+rollno+"','"+password+"','waiting')");
         if(i>0){
            %>
